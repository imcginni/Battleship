...
This document outlines the architecture for the Battleship game, including its online and offline modes.
...
This diagram shows the main components of the system and their relationships, drawn as a Class Diagram.
...
classDiagram
    ...
    BattleshipServer "1" -- "2" BattleshipClient : hosts (network_connection)
    BattleshipServer ..> CommonLogic : uses
    BattleshipClient ..> CommonLogic : uses
```
## ## 2. Sequence Diagram

This diagram shows the "how" and "when" of communication for a complete turn in the online mode.

This example covers Player 1 firing a shot that HITS, allowing them to fire again, and then firing a shot that MISSES, causing a turn change.
